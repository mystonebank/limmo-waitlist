...
const Card = ({ to, title, subtitle, Icon }: { to: string; title: string; subtitle: string; Icon: any }) => (
  <Link
    to={to}
    className="group rounded-xl border border-border bg-card/50 backdrop-blur p-6 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl hover:ring-2 hover:ring-ring/60"
  >
    ...
    <main className="min-h-screen bg-background">
      <section className="container py-20">
        <header className="text-center mb-12">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-primary drop-shadow-sm">Limmo</h1>
