...
const Auth = () => {
  ...
  return (
    <main className="min-h-screen grid place-items-center bg-background">
      <section className="w-full max-w-md p-8 rounded-xl border border-border bg-card/60 backdrop-blur">
        <header className="text-center mb-6">
          <h1 className="text-4xl font-semibold tracking-tight text-primary">Limmo</h1>
          <p className="text-sm text-muted-foreground mt-2">Your pocket cheerleader</p>
        </header>

        <div className="space-y-3">
          <Button className="w-full" onClick={signInWithGoogle} variant="default">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button onClick={signUpWithEmail} variant="secondary">Sign up</Button>
            <Button onClick={signInWithEmail} variant="outline">Sign in</Button>
          </div>
        </div>
      </section>
    </main>
